...
class Effects
{
	...
	public function fidget(movable:Movable, angle:Float, callback:Callback = null)
	{
	...
	/*public function spinAround(object:Dynamic, period:Float):FlxTween
		{
			var onComplete = tween -> spinAround(object, period);
			return FlxTween.angle(object, object.angle, object.angle + 180, period / 2)
				.then(FlxTween.angle(object, object.angle + 180, object.angle + 360, period / 2, {
